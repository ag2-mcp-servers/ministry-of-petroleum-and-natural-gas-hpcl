...
#   timestamp: 2025-06-28T15:05:13+00:00
...
class CertificateParameters(BaseModel):
    ...
    LPGId: str = Field(..., description='LPG ID', examples=['21100668300009481'])
    SVNo: str = Field(..., description='SV No', examples=['1010935'])
...
class LpgsvCertificatePostRequest(BaseModel):
...
class LpgsvCertificatePostResponse(BaseModel):
...
class LpgsvCertificatePostResponse1(BaseModel):
...
class LpgsvCertificatePostResponse2(BaseModel):
...
class LpgsvCertificatePostResponse3(BaseModel):
...
class LpgsvCertificatePostResponse4(BaseModel):
...
class LpgsvCertificatePostResponse5(BaseModel):
...
class LpgsvCertificatePostResponse6(BaseModel):
